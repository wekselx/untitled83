package emulator.wekse.ua.Map;


import Ucf.veksel.ua.XUcfCoder;
import emulator.wekse.ua.Cell.XCellRenderer;
import emulator.wekse.ua.Logistic.XMath;
...
public class XMapPanel extends JTable {
    ...
    private void setupView() {
        ...
        try {
            Font customFont = Font.createFont(Font.TRUETYPE_FONT, new File("map-units.ttf")).deriveFont(7f);
            setFont(customFont);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void setupCells() {
        ...
        try {
            fis = new FileInputStream("test-data.dat");
